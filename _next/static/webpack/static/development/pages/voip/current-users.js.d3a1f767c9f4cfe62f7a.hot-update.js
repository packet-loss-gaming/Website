...
function (_React$Component) {
  ...
  _createClass(VoIPViewer, [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch('https://www.nfoservers.com/query/mstat.pl?id=pktloss');
    ...
    value: function render() {
      ...
      if (this.state) {
        dataPreview = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 29
          },
          __self: this
        }, "Preact has ", this.state.stars, " \u2B50\uFE0F");
      } else {
...
//# sourceMappingURL=current-users.js.d3a1f767c9f4cfe62f7a.hot-update.js.map