...
function (_React$Component) {
  ...
  function VoIPViewer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getChannelIndent", function (channelLevel) {
      ...
      return level * LEVEL_INDENT_AMT;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderChannelName", function (channelData) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderChannelUsers", function (channelData, channelLevel) {
      ...
      channelData.users.forEach(function (user) {
        var userStyle = {
          marginLeft: getChannelIndent(channelLevel + 1) + 'px'
        };
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderChannel", function (channelData, channelLevel) {
      var channelStyle = {
        marginLeft: getChannelIndent(channelLevel) + 'px'
      };
      var subChannels = [];
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        __self: this
      }, _this.renderChannelName(channelData), users, subChannels);
    });
...
//# sourceMappingURL=current-users.js.f3ece6167879a19659f5.hot-update.js.map