...
function (_React$Component) {
  ...
  function VoIPViewer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "getChannelIndent", function () {
      return 40;
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderChannelUsers", function (channelData) {
      var users = [];
      channelData.users.forEach(function (user) {
        var userStyle = {
          marginLeft: _this.getChannelIndent() + 'px'
        };
...
//# sourceMappingURL=current-users.js.f4da1a3658076ec58b1b.hot-update.js.map