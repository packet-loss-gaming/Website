...
function (_React$Component) {
  ...
  function VoIPViewer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderChannel", function (channelData) {
      var users = [];
      ...
      channelData.channels.forEach(function (channel) {
        subChannels.push(renderChannel(channel));
      });
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        ...
        __self: this
      }, channelData.name, usersList, subChannels);
    });
  ...
  _createClass(VoIPViewer, [{
    ...
    value: function render() {
      ...
      if (this.state.rootChannel) {
        dataPreview = this.renderChannel(this.state.rootChannel);
      } else {
        dataPreview = react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 52
          },
...
//# sourceMappingURL=current-users.js.d2e5e102ab3fd443e21e.hot-update.js.map