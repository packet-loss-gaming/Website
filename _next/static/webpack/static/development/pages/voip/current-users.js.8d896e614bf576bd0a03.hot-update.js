...
function (_React$Component) {
  ...
  function VoIPViewer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderChannel", function (channelData, level) {
      ...
      var channelIndent = level * LEVEL_INDENT_AMT;
      var channelStyle = {
        marginLeft: channelIndent + 'px'
      };
      var users = [];
      channelData.users.forEach(function (user) {
        var userStyle = {
          marginLeft: channelIndent + LEVEL_INDENT_AMT + 'px'
        };
...
//# sourceMappingURL=current-users.js.8d896e614bf576bd0a03.hot-update.js.map